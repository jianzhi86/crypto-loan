...
export default function HomeContent() {
  return (
    <Box sx={{ minHeight: '100vh', bgcolor: C.bg, color: C.ink }}>
        ...
        <Container maxWidth="lg" sx={{ position: 'relative', zIndex: 1, pt: { xs: 7, md: 12 }, pb: { xs: 6, md: 9 } }}>
          <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', md: '1.1fr 0.9fr' }, gap: { xs: 5, md: 6 }, alignItems: 'center' }}>
            ...
            <Box>
              ...
              <Typography component="h1" sx={{ fontFamily: DISPLAY, fontSize: { xs: 38, sm: 50, md: 60 }, fontWeight: 700, lineHeight: 1.05, letterSpacing: '-1.5px', mb: 2.5, color: C.ink }}>
                ...
                <Box component="span" sx={{ display: 'block', minHeight: '1.15em', color: C.indigo }}>
                  <TextScramble phrases={HERO_PHRASES} scrambleColor={C.indigoHi} />
                </Box>
              </Typography>
      ...
      {/* ── Features ─────────────────────────────────────── */}
      <Container maxWidth="lg" id="features" sx={{ py: { xs: 7, md: 11 }, scrollMarginTop: 80 }}>
        <Box sx={{ mb: 5 }}>
      ...
      {/* ── How it works ─────────────────────────────────── */}
      <Box id="how" sx={{ bgcolor: C.surface, borderTop: `1px solid ${C.line}`, borderBottom: `1px solid ${C.line}`, scrollMarginTop: 80 }}>
      ...
      {/* ── FAQ ──────────────────────────────────────────── */}
      <Box id="faq" sx={{ bgcolor: C.surface, borderTop: `1px solid ${C.line}`, scrollMarginTop: 80 }}>
        <Container maxWidth="lg" sx={{ py: { xs: 7, md: 11 } }}>
          <Box sx={{ mb: 5 }}>
